          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="flex space-x-4 text-white text-2xl">
                <a href="https://www.instagram.com/dominator_towing?igsh=eG81YjhnZ295OHhl" target="_blank" rel="noopener noreferrer">
                  <FaInstagram />
                </a>
                <a href="https://www.facebook.com/share/16WJYTeWzQ/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
                  <FaFacebook />
                </a>
                <a href="https://www.tiktok.com/@dominator_towing?_t=ZT-8xcK0gKZdIk&_r=1" target="_blank" rel="noopener noreferrer">
                  <FaTiktok />
                </a>
              </div>
            </div>
