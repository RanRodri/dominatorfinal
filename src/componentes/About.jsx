          ...
          <div className="flex justify-center px-4 sm:px-8 md:px-16 py-5 w-full">
            <div className="flex flex-col w-full max-w-[960px]">
              ...
              <div className="relative rounded-xl overflow-hidden min-h-[320px]">
                ...
                <div className="relative z-10 flex flex-col gap-6 sm:gap-8 items-start justify-end px-4 pb-10 sm:px-10 h-full text-white">
              ...
              <div className="p-4">
                <div className="flex flex-col md:flex-row gap-4 rounded-xl">
                  ...
                  <div
                    ...
                    style={{ backgroundImage: 'url("/Images/about5.jpg")' }}
                  />
                </div>
              </div>
